...
//шаблонний варіант воїна. Зробити декілька типів воїнів-
//наслідників. Кожен з них має свої особливості , наприклад
//hp, зброя і т.д. Тут потрібно проявити свою фантазію і
//додавати класи, які хочеться.
//Потім має бути битва. Воїни можуть атакувати, якщо вони
//атакують, життя зменшується. На кожному етапі показувати
//інфу. Наприклад :